...
std::vector<int64_t> solve(int N, int64_t X, int64_t Y, const std::vector<char> &C, const std::vector<int64_t> &A, const std::vector<int64_t> &B) {
    // TODO: edit here
}
