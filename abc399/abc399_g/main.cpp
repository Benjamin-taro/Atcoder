...
int64_t solve(int64_t N, int M, int C, const std::vector<int64_t> &A, const std::vector<int64_t> &u, const std::vector<int64_t> &v, const std::vector<int64_t> &c) {
    // TODO: edit here
}
