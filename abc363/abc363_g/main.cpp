...
auto solve(int a, int b, const std::vector<int64_t> &c, const std::vector<int64_t> &d, const std::vector<int64_t> &e, const std::vector<int64_t> &f, const std::vector<int64_t> &g) {
    // TODO: edit here
}
...
int main() {
    ...
    std::cin >> b;
    std::vector<int64_t> e(b), f(b), g(b);
    REP (i, a) {
        std::cin >> c[i];
    }
    REP (i, a) {
