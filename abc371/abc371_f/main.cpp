...
int64_t solve(int N, const std::vector<int64_t> &X, int Q, const std::vector<int64_t> &T, const std::vector<int64_t> &G) {
    // TODO: edit here
}
...
int main() {
    ...
    std::cin >> Q;
    std::vector<int64_t> T(Q), G(Q);
    REP (i, Q) {
        std::cin >> T[i] >> G[i];
    }
    auto ans = solve(N, X, Q, T, G);
    std::cout << ans << '\n';
    return 0;
}
