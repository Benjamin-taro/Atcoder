...
auto solve(int N, const std::vector<int64_t> &X, const std::vector<int64_t> &P, int Q, const std::vector<int64_t> &L, const std::vector<int64_t> &R) {
    // TODO: edit here
}
