...
double solve(int N, const std::vector<int64_t> &Ax, const std::vector<int64_t> &Ay, const std::vector<int64_t> &Bx, const std::vector<int64_t> &By) {
    // TODO: edit here
}
