...
auto solve(int N, int Q, const std::vector<int64_t> &X, const std::vector<int64_t> &A, const std::vector<int64_t> &B, const std::vector<int64_t> &V, const std::vector<int64_t> &K) {
    // TODO: edit here
}
...
int main() {
    ...
    int N, Q;
    std::cin >> N;
    std::vector<int64_t> X(N), A(N - 1), B(N - 1);
    std::cin >> Q;
