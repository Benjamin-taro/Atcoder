...
std::vector<auto> solve(int N, int M, const std::vector<int64_t> &A, const std::vector<int64_t> &U, const std::vector<int64_t> &V, const std::vector<int64_t> &B) {
    // TODO: edit here
}
...
int main() {
    ...
    std::cin >> M;
    std::vector<int64_t> U(M), V(M), B(M);
    REP (i, N) {
        std::cin >> A[i];
    }
    REP (i, M) {
