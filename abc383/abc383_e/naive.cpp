...
int64_t solve(int64_t N, int M, int K, const std::vector<int64_t> &u, const std::vector<int64_t> &v, const std::vector<int64_t> &w, const std::vector<int64_t> &A, const std::vector<int64_t> &B) {
    // TODO: edit here
}
...
int main() {
    ...
    auto ans = solve(N, M, K, u, v, w, A, B);
    std::cout << ans << '\n';
    return 0;
}
