...
string solve(int64_t N) {
    ...
    int64_t temp = N/5;
    if(temp%6 == 0) target = "123456";
    else if(temp%6 == 1) target = "234561";
    else if(temp%6 == 2) target = "345612";
    else if(temp%6 == 3) target = "456123";
    else if(temp%6 == 4) target = "561234";
    else if(temp%6 == 5) target = "612345";
    vector<char> v;
    for(int i = 0; i < 6; i++){
