...
auto solve(int a, const std::vector<int64_t> &b, const std::vector<std::vector<int64_t> > &c, const std::vector<std::vector<int64_t> > &d, const std::vector<int64_t> &e, const std::vector<int64_t> &f) {
    // TODO: edit here
}
