...
int64_t solve(int N, const std::vector<int64_t> &P, const std::vector<int64_t> &C, const std::vector<int64_t> &D) {
    // TODO: edit here
}
...
int main() {
    ...
    int N;
    std::cin >> N;
    std::vector<int64_t> P(N - 1), C(N), D(N);
    REP (i, N - 1) {
        std::cin >> P[i];
    }
    REP (i, N) {
