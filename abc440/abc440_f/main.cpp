...
auto solve(int N, int Q, const std::vector<int64_t> &A, const std::vector<int64_t> &B, const std::vector<int64_t> &W, const std::vector<int64_t> &X, const std::vector<int64_t> &Y) {
    // TODO: edit here
}
...
int main() {
    ...
    std::cin >> Q;
    std::vector<int64_t> W(Q), X(Q), Y(Q);
    REP (i, N) {
        std::cin >> A[i] >> B[i];
    }
    REP (i, Q) {
