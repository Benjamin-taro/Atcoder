...
int64_t solve(int N, int64_t K, const std::vector<int64_t> &A, const std::vector<int64_t> &U, const std::vector<int64_t> &V) {
    // TODO: edit here
}
...
int main() {
    ...
    int64_t K;
    std::cin >> N;
    std::vector<int64_t> A(N), U(N - 1), V(N - 1);
    std::cin >> K;
    REP (i, N) {
        std::cin >> A[i];
    }
