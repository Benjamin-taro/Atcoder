...
auto solve(int N, const std::vector<int64_t> &A, int Q, const std::vector<int64_t> &l, const std::vector<int64_t> &r, const std::vector<int64_t> &k) {
    // TODO: edit here
}
...
int main() {
    ...
    std::cin >> Q;
    std::vector<int64_t> l(Q), r(Q), k(Q);
    REP (i, Q) {
        std::cin >> l[i] >> r[i] >> k[i];
    }
    auto ans = solve(N, A, Q, l, r, k);
    REP (i, Q) {
        std::cout << a[i] << '\n';
    }
    return 0;
