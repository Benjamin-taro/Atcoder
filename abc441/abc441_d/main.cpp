...
auto solve(int64_t N, int M, int64_t L, int64_t S, int64_t T, const std::vector<int64_t> &U, const std::vector<int64_t> &V, const std::vector<int64_t> &C) {
    // TODO: edit here
}
...
int main() {
    ...
    auto ans = solve(N, M, L, S, T, U, V, C);
