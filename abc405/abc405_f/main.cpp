...
auto solve(int64_t N, int M, const std::vector<int64_t> &A, const std::vector<int64_t> &B, int Q, const std::vector<int64_t> &C, const std::vector<int64_t> &D) {
    // TODO: edit here
}
