...
auto solve(int N, const std::vector<int64_t> &A, const std::vector<int64_t> &B, int Q, const std::vector<int64_t> &L, const std::vector<int64_t> &R) {
    // TODO: edit here
}
