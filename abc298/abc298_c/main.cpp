...
int main() {
    ...
    int n, q;
    std::cin >> n >> q;
    std::vector<std::multiset<int>> box(n + 1); // Initializing with n + 1 to handle 1-based indexing
    std::unordered_map<int, std::set<int>> number; // Using unordered_map for sparse storage of numbers
    ...
    for(int k = 0; k < q; k++){
        ...
        if(a == 1){
            ...
            std::cout << std::endl; // Add a newline after output
        }
        else if(a == 3){
            int i;
            std::cin >> i;
