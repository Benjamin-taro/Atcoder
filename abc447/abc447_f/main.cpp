...
auto solve(auto a, const std::vector<auto> &b, const std::vector<std::vector<auto> > &c, const std::vector<std::vector<auto> > &d) {
    // TODO: edit here
}
...
int main() {
    ...
    std::cin >> a;
    std::vector<auto> b(a);
    std::vector<std::vector<auto> > c(a, std::vector<auto>((b_i))), d(a, std::vector<auto>((b_i)));
    REP (i, a) {
        std::cin >> b[i];
        REP (j, b_i) {
            std::cin >> c[i][j] >> d[i][j];
