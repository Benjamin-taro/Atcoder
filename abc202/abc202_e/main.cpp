...
auto solve(int N, const std::vector<int64_t> &P, int Q, const std::vector<int64_t> &U, const std::vector<int64_t> &D) {
    // TODO: edit here
}
...
int main() {
    ...
    std::cin >> Q;
    std::vector<int64_t> U(Q), D(Q);
    REP (i, Q) {
        std::cin >> U[i] >> D[i];
    }
    auto ans = solve(N, P, Q, U, D);
    std::cout << n << '\n';
    REP (i, n) {
        std::cout << a[i] << '\n';
    }
