...
int64_t solve(int64_t N, int G, int E, const std::vector<int64_t> &p, const std::vector<int64_t> &a, const std::vector<int64_t> &b) {
    // TODO: edit here
}
