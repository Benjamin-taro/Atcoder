...
int main() {
    ...
    sort(ALL(painted));
    int h_l = painted[0].first;
    int h_r = painted.back().first;
    sort(ALL(painted), [](auto a, auto b){return a.second < b.second;});
    int w_l = painted[0].second;
    int w_r = painted.back().second;

    for(int i = h_l; i <= h_r; i++){
