...
double solve(int N, int M, const std::vector<int64_t> &X, const std::vector<int64_t> &Y, const std::vector<int64_t> &P, const std::vector<int64_t> &Q) {
    // TODO: edit here
}
