...
auto solve(int N, const std::vector<int64_t> &a, const std::vector<int64_t> &b, const std::vector<int64_t> &c, int Q, int64_t K, const std::vector<int64_t> &x, const std::vector<int64_t> &y) {
    // TODO: edit here
}
