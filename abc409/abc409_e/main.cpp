...
int64_t solve(int N, const std::vector<int64_t> &x, const std::vector<int64_t> &u, const std::vector<int64_t> &v, const std::vector<int64_t> &w) {
    // TODO: edit here
}
...
int main() {
    ...
    int N;
    std::cin >> N;
    std::vector<int64_t> x(N), u(N - 1), v(N - 1), w(N - 1);
    REP (i, N) {
        std::cin >> x[i];
    }
    REP (i, N - 1) {
