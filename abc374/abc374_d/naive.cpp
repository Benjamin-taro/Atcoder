...
double solve(int N, int64_t S, int64_t T, const std::vector<int64_t> &A, const std::vector<int64_t> &B, const std::vector<int64_t> &C, const std::vector<int64_t> &D) {
    // TODO: edit here
}
