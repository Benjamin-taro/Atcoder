...
int64_t solve(int64_t N, int M, int K, const std::vector<int64_t> &A, const std::vector<int64_t> &B, const std::vector<int64_t> &C, const std::vector<int64_t> &E) {
    // TODO: edit here
}
