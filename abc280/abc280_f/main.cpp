...
auto solve(int64_t N, int M, int Q, const std::vector<int64_t> &A, const std::vector<int64_t> &B, const std::vector<int64_t> &C, const std::vector<int64_t> &X, const std::vector<int64_t> &Y) {
    // TODO: edit here
}
...
int main() {
    ...
    auto ans = solve(N, M, Q, A, B, C, X, Y);
    REP (i, Q) {
        std::cout << a[i] << '\n';
    }
    return 0;
