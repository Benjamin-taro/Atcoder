...
auto solve(int N, const std::vector<int64_t> &A, const std::vector<int64_t> &B, int K, const std::vector<int64_t> &X, const std::vector<int64_t> &Y) {
    // TODO: edit here
}
