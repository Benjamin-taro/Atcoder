...
auto solve(int a, const std::vector<int64_t> &b, const std::vector<int64_t> &c, const std::vector<std::vector<std::string> > &d) {
    // TODO: edit here
}
...
int main() {
    ...
    std::vector<std::vector<std::string> > d(a, std::vector<std::string>((b_i)));
    REP (i, a) {
        std::cin >> b[i] >> c[i];
        REP (j, b_i) {
            std::cin >> d[i][j];
