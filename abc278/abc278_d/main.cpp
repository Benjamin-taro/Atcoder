...
int main() {
    ...
    std::vector<int64_t> a_(n, 0);
    std::vector<int64_t> last_update(n, -1);
    ...
    REP(i, q) {
        ...
        if (x == 3) {
            ...
            b--;
            if (update) {
                if (last_update[b] < current_time) {
                    std::cout << base_value << std::endl;
                } else {
                    std::cout << base_value + a_[b] << std::endl;
                }
            } else {
                std::cout << a[b] + a_[b] << std::endl;
            }
        } 
        else if (x == 2) {
            int64_t b, c;
