...
std::string solve(int N, int M, const std::vector<int64_t> &A, const std::vector<int64_t> &B, const std::vector<int64_t> &C, const std::vector<int64_t> &D, const std::vector<int64_t> &E, const std::vector<int64_t> &F) {
    // TODO: edit here
}
...
int main() {
    ...
    std::cin >> M;
    std::vector<int64_t> D(M), E(M), F(M);
    REP (i, N) {
        std::cin >> A[i] >> B[i] >> C[i];
    }
    REP (i, M) {
