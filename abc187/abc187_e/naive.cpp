...
auto solve(int N, const std::vector<int64_t> &a, const std::vector<int64_t> &b, int Q, const std::vector<int64_t> &t, const std::vector<int64_t> &e, const std::vector<int64_t> &x) {
    // TODO: edit here
}
...
int main() {
    ...
    std::cin >> Q;
    std::vector<int64_t> t(Q), e(Q), x(Q);
    REP (i, Q) {
        std::cin >> t[i] >> e[i] >> x[i];
    }
    auto ans = solve(N, a, b, Q, t, e, x);
    REP (i, N) {
        std::cout << ans[i] << '\n';
    }
    return 0;
