...
int main() {
    ...
    int64_t n, t;
    cin >> n >> t;
    vector<int64_t> row_count(n, 0), col_count(n, 0);
    int64_t main_diag_count = 0, anti_diag_count = 0;
    ...
    for (int64_t i = 0; i < t; ++i) {
        ...
        if (row_count[row] == n || col_count[col] == n || main_diag_count == n || anti_diag_count == n) {
            cout << i + 1 << endl;
            return 0;
        }
    }
