...
auto solve(auto N, auto M, auto L, const std::vector<auto> &A, const std::vector<auto> &B, const std::vector<auto> &C, auto Q, const std::vector<auto> &s, const std::vector<auto> &t) {
    // TODO: edit here
}
...
int main() {
    ...
    std::cin >> Q;
    std::vector<auto> s(Q), t(Q);
    REP (i, Q) {
        std::cin >> s[i] >> t[i];
    }
    auto ans = solve(N, M, L, A, B, C, Q, s, t);
