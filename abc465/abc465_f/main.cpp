...
auto solve(int a, const std::vector<std::string> &b, const std::vector<int64_t> &c, int d, const std::vector<std::string> &e, const std::vector<std::string> &f) {
    // TODO: edit here
}
