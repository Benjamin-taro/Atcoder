...
auto solve(int N, const std::vector<int64_t> &q, const std::vector<int64_t> &r, int Q, const std::vector<int64_t> &t, const std::vector<int64_t> &d) {
    // TODO: edit here
}
...
int main() {
    ...
    std::cin >> Q;
    std::vector<int64_t> t(Q), d(Q);
    REP (i, Q) {
        std::cin >> t[i] >> d[i];
    }
    auto ans = solve(N, q, r, Q, t, d);
    REP (i, N) {
        std::cout << e[i] << '\n';
    }
    std::cout << f << '\n';
