...
auto solve(int64_t N, int Q, const std::vector<int64_t> &l, const std::vector<int64_t> &r, const std::vector<int64_t> &a) {
    // TODO: edit here
}
...
int main() {
    ...
    int Q;
    std::cin >> N >> Q;
    std::vector<int64_t> l(Q), r(Q), a(Q);
    REP (i, Q) {
        std::cin >> l[i] >> r[i] >> a[i];
    }
    auto ans = solve(N, Q, l, r, a);
    REP (i, Q) {
        std::cout << b[i] << '\n';
    }
    return 0;
