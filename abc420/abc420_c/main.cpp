...
auto solve(int N, int Q, const std::vector<int64_t> &A, const std::vector<int64_t> &B, const std::vector<char> &c, const std::vector<int64_t> &X, const std::vector<int64_t> &V) {
    // TODO: edit here
}
