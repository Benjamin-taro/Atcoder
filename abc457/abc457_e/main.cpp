...
auto solve(int64_t N, int M, const std::vector<int64_t> &L, const std::vector<int64_t> &R, int Q, const std::vector<int64_t> &S, const std::vector<int64_t> &T) {
    // TODO: edit here
}
