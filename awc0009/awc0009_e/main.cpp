...
// ===== SegTree (generic) =====
// 使い方例：
// SegTree<ll, OpMax<ll>> seg(a, OpMax<ll>::id());
// SegTree<ll, OpMin<ll>> seg(a, OpMin<ll>::id());
...
int main() {
    ...
    REP(i, n) cin >> a[i];
    int64_t INF = 1LL << 60;
    SegTree<int64_t, OpMax<int64_t>> segmax(a);
    SegTree<int64_t, OpMin<int64_t>> segmin(a);
    REP(i, q){
        int64_t l, r;
        cin >> l >> r;
        --l; --r;
        cout << int64_t(abs(segmax.query(l, r+1) - segmin.query(l, r+1))) << "\n";
    }
    return 0;
}
